...
# Configure IP
#
# This configures the IP address for the Pi. If
# searches for a free IP address inside the static
# range and sets this to it.
#
# Does nothing if IP set by DHCP
###
...
print "Setting IP address as " + TARGET_IP_ADDRESS
